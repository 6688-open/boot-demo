 ...
 */
@Component
@Module(businessType = "SO")
public class SoBillExceptionServiceImpl implements ExceptionService {
    private static final Logger logger = LoggerFactory.getLogger(SoBillExceptionServiceImpl.class);
    ...
    public Response retryException(BillExceptionRequest request) {
        ...
        try {
            ...
            logger.error("SO retryException  error", e);
