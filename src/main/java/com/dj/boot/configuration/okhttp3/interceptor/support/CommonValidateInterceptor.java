...
import com.dj.boot.configuration.okhttp3.executor.PostJsonBodyExecutor;
...
public class CommonValidateInterceptor extends ExecutorInterceptorAdapter {
    private final static Logger log = LoggerFactory.getLogger(CommonValidateInterceptor.class);
    @Override
