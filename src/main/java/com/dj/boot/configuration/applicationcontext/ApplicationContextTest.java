...
public class ApplicationContextTest {
    ...
    public void test() throws IOException {
        Resource r = new ClassPathResource("applicationcontext/applicationContext.xml");
        ...
        //ApplicationContext context = new MyClassPathXmlApplicationContext("applicationcontext/applicationContext.xml");
