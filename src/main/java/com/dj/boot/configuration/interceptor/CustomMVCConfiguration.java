...
//    }
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        //registry.addInterceptor(interceptorConfig()).excludePathPatterns("/toLogin","/user/userLogin", "/swagger**/**", "/user/addUser").addPathPatterns("/**");
        registry.addInterceptor(interceptorConfig()).excludePathPatterns("/**/**").addPathPatterns("/**");
        //registry.addInterceptor(permissionInterceptor()).excludePathPatterns("/toLogin","/user/userLogin", "/swagger**/**", "/user/addUser").addPathPatterns("/**");
