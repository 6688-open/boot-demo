...
public class JtSecurityLoggerFactory extends SecurityLoggerFactory {
    private static final Logger log = DefaultFactory.getLogger(JtSecurityLoggerFactory.class);

    //输出日志静态变量
    private static String PATTERN = "%m%n";
    private static Charset CHARSET = Charset.forName("Utf-8");
    private static String FILEPATH = "/export/Logs/user-record";
    private static String FILENAME = "/user-jt-security.log";
    private static String FILENAMEPATTERN = "/user-jt-security-%i.log.gz";
    private static String APPENDERNAME = "securityFile";
    private static String FILESIZE = "500MB";
    private static String MAX = "3";
    private static String LOGGERNAME = "user-jt-security";
