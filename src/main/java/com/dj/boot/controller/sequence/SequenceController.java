...
public class SequenceController {
    ...
    public void test () {
        ...
        long id = sequenceService.insertAndGetSequence(PkTable.Btp_DjUser.getTable());
        long itemId = sequenceService.insertAndGetSequence(PkTable.Btp_CompensateItem.getTable());
